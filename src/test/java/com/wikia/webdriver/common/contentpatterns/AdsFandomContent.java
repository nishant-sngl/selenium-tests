...
public class AdsFandomContent {
  ...
  static {
    ...
    SLOT_SELECTORS.put(FEED_BOXAD,
                       "div[id$='google_ads_iframe_/5441/wka1a.PF/feed_boxad/desktop/ns-article/_fandom-all_0__container__']");
